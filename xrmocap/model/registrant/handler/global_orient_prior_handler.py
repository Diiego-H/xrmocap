...
_GlobalOrientPriorLoss = TypeVar('_GlobalOrientPriorLoss')


class GlobalOrientPriorHandler(BaseHandler):

    def __init__(self,
                 prior_loss: Union[_GlobalOrientPriorLoss, dict],
                 handler_key='global_orient',
                 device: Union[torch.device, str] = 'cuda',
                 logger: Union[None, str, logging.Logger] = None) -> None:
        """Construct a GlobalOrientPriorHandler instance compute smpl(x/xd) global orientation
    ...
    def __call__(self,
        ...
        Args:
            global_orient (torch.Tensor):
                The global orientation parameters. In shape (batch_size, 3).
