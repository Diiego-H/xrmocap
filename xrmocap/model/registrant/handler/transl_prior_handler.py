...
_TranslPriorLoss = TypeVar('_TranslPriorLoss')


class TranslPriorHandler(BaseHandler):

    def __init__(self,
                 prior_loss: Union[_TranslPriorLoss, dict],
                 handler_key='transl_prior',
                 device: Union[torch.device, str] = 'cuda',
                 logger: Union[None, str, logging.Logger] = None) -> None:
        """Construct a TranslPriorHandler instance compute smpl(x/xd) translation
    ...
    def __call__(self,
        ...
        Args:
            transl (torch.Tensor):
                The translation parameters. In shape (batch_size, 3).
